...
import proyectoprogra3.ProyectoProgra3;
import proyectoprogra3.controller.Controller;
...
public class FlowController {
    ...
    private FXMLLoader getLoader(String name) {
        ...
        if (loader == null) {
            synchronized (FlowController.class) {
                if (loader == null) {
                    try {
                        loader = new FXMLLoader(ProyectoProgra3.class.getResource("view/" + name + ".fxml"), this.idioma);
 ...
 public void delete(String p)
 {
    ...
    public void goMain() {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(ProyectoProgra3.class.getResource("view/logIn.fxml"), this.idioma)));
           // this.mainStage.getScene().setFill(Color.TRANSPARENT);
            this.mainStage.show();
    ...
    public void goView(String viewName, String location, String accion) {
        ...
        if (stage == null) {
           ...
           // controller.getStage().getIcons().add(new Image("/tarea/resources/icon1.png"));
        }
        switch (location) {
            case "Center":
    ...
    public void salirPantallaSecundaria(Window w)
    {
        w.hide();
    }
}
