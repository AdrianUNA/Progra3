...
public class FlowController {
    ...
    private FXMLLoader getLoader(String name) {
        ...
        if (loader == null) {
            synchronized (FlowController.class) {
                if (loader == null) {
                    try {
                        loader = new FXMLLoader(CineUNA.class.getResource("view/" + name + ".fxml"), this.idioma);
 ...
 public void delete(String p)
 {
    ...
    public void goMain() {
        try {
            this.mainStage.setScene(new Scene(FXMLLoader.load(CineUNA.class.getResource("view/logIn.fxml"), this.idioma)));
